---
title: "Choose an alpha value for connectivity"
...
knitr::opts_chunk$set(fig.path = "figures/2023-02-10_choose-alpha-value/")
...
*r* is the average migration distance of Hawthorn enemies and *r* = 1 / $\alpha$
...
The model using a radius of **50** to calculate connectivity has the lowest AIC. 
We don't have data beyond a 50m radius,
but it honestly looks to me like its levelling off here anyway.
